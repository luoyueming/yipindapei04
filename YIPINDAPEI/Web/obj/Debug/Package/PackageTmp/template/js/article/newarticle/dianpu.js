...
function GoPage(page) {
    ...
    var curls = navname + "index_" + page + ".html";

    if (navname == "/dapei/") {
        curls = navname + "list_" + page + ".html";
    }

    if (navname.indexOf(".html") >= 0) {
        if (navname == "/dapei/") {
            if (navname.indexOf("/list_") < 0) {
                curls = navname.replace(".html", "") + "_" + page + ".html";
            }
        }
        else {
            if (navname.indexOf("/index_") < 0) {
                curls = navname.replace(".html", "") + "_" + page + ".html";
            }
        }
    }
