...
namespace NewXzc.Common
{
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name = "smsSoap", Namespace = "http://106.ihuyi.cn/")]
    public partial class sms : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public sms()
        {
            this.Url = "http://106.ihuyi.cn/webservice/sms.php?smsService";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.xmlsoap.org/Submit", RequestNamespace = "http://106.ihuyi.cn/", ResponseNamespace = "http://106.ihuyi.cn/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public SubmitResult Submit(string account, string password, string mobile, string content)
        {
            #region  宋明亮 2014-07-23  给定短信平台的用户名和密码
            account = "cf_hrh";
            password = "X5g8Q4V3";//密码可以使用明文密码或使用32位MD5加密
            #endregion
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.xmlsoap.org/ChangePassword", RequestNamespace = "http://106.ihuyi.cn/", ResponseNamespace = "http://106.ihuyi.cn/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.xmlsoap.org/GetNum", RequestNamespace = "http://106.ihuyi.cn/", ResponseNamespace = "http://106.ihuyi.cn/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.xmlsoap.org/VersionInfo", RequestNamespace = "http://106.ihuyi.cn/", ResponseNamespace = "http://106.ihuyi.cn/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://106.ihuyi.cn/")]
