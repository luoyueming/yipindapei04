...
{
    public class CookieHelper_HongRenHui
    {
        CookieHelper_HongRenHui()
        {
        ...
        public static string GetCookieForManager(string strName)
        {
            if (HttpContext.Current.Request.Cookies != null
                && HttpContext.Current.Request.Cookies["InHren_RedD6Manager"] != null
                && HttpContext.Current.Request.Cookies["InHren_RedD6Manager"][strName] != null)
            {
                return UrlDecode(HttpContext.Current.Request.Cookies["InHren_RedD6Manager"][strName].ToString());
            }
            return "";
        }
        /// <summary>
        ...
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies["Hren_RedParty"];

            if (cookie == null)
            {
                cookie = new HttpCookie("Hren_RedParty");
                cookie.Values[strName] = UrlEncode(strValue);
            }
            else
            {
                cookie.Values[strName] = UrlEncode(strValue);
                if (HttpContext.Current.Request.Cookies["Hren_RedParty"]["expires"] != null)
                {
                    int expires = StrToInt(HttpContext.Current.Request.Cookies["Hren_RedParty"]["expires"].ToString(), 0);
                    if (expires > 0)
                    {
                        cookie.Expires = DateTime.Now.AddDays(StrToInt(HttpContext.Current.Request.Cookies["Hren_RedParty"]["expires"].ToString(), 0));
                    }
                }
            }
        ...
        {
            HttpCookie cookie = new HttpCookie("Hren_RedParty");
            ...
            string cookieDomain = "Hren_Redd6party.com";
            if (cookieDomain != string.Empty && HttpContext.Current.Request.Url.Host.IndexOf(cookieDomain) > -1 && IsValidDomain(HttpContext.Current.Request.Url.Host))
            {
                cookie.Domain = cookieDomain;
            }
        ...
        {
            if (HttpContext.Current.Request.Cookies != null
                && HttpContext.Current.Request.Cookies["Hren_RedParty"] != null
                && HttpContext.Current.Request.Cookies["Hren_RedParty"][strName] != null)
            {
                return UrlDecode(HttpContext.Current.Request.Cookies["Hren_RedParty"][strName].ToString());
            }
            return "";
        }
